...
//           }
//         >
//           <Route index element={<ProfileA />} />
//           <Route path="manageempa" element={<ManageEmpA />} />
//           <Route path="add-emplyoee" element={<AddEmp />} />
//           <Route path="manageclienta" element={<ManageClientA />} />
//           <Route path="manageinventorya" element={<ManageInventoryA />} />
//         </Route>
...
//           <Route path="taske" element={<TaskE />} />
//           <Route path="attendancee" element={<AttendanceE />} />
//           <Route path="reimbursemente" element={<ReimbursementE />} />
//           <Route path="managecliente" element={<ManageClientE />} />
//           <Route path="leavee" element={<LeaveE />} />
//         </Route>
...
//           }
//         >
//           <Route index element={<ProfileC />} />
//           <Route path="checkupdc" element={<CheckUpdC />} />
//         </Route>
//       </Routes>
//     </BrowserRouter>
//   );
    ...
    <BrowserRouter>
      <Routes>
        ...
        >
          ...
          <Route path="/homea/add-employee" element={<AddEmp />} />
